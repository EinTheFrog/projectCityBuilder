...
public class FieldCore {
     ...
     * устанавливает ауру для нового здания в зависимости от клекток, на которых его построили,
    ...
    /**
     * Метод для установки здания для всех клеток в области, которая находится под зданием
